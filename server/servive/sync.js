...
class SyncWsManager {
     ...
     */
    listenClientConnect() {
        this.server.ws('/x/ws/sync/:groupId', (ws, req) => {
    ...
    receiveMsg(groupId, devInfo, msg) {
        ...
        switch (msgEvent) {
            case MsgType.ping: {
                ...
                this.sendMsg(groupId, devInfo.deviceId, {msgEvent: MsgType.sync, devs: devs, token: totp.generate()})
                break
            }
